...
public class CalenderPopupRandomDate {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//navigate to any future date in calender
		for(;;)
		{
			try 
			{//not visible-execption-visible-click()
				driver.findElement(By.xpath("//div[@aria-label='Fri Dec 01 2023']")).click();
				break;
			} 
			catch (Exception e)
			{
